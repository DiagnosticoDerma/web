	...
	<div class="card-body">
		<form id="form-tratamiento">
			...
			<div class="mb-3">
				...
				{!! Form::textarea('recomendaciones', $enfermedad_tratamiento->recomendaciones, ['class' => 'form-control','rows' => '3','id' => 'recomendaciones']) !!}
			</div>
			<div class="mb-3 row">
...
<script>
	...
	$("#form-tratamiento").submit(function(e) {
		...
		let url = `/diagnostico/${id_enfermedad_tratamiento}/tratamiento-update`;
		loading("show");
		$.post(url, data, function(res) {
			loading("hide");
			if(res.result){
