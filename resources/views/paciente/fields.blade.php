...
<div class="mb-3 row">
	...
	<label class="col-form-label col-sm-1 text-sm-end">Talla</label>
	<div class="col-sm-2">
		{!! Form::text('talla', null, ['class' => 'form-control decimal','data-validation' => 'required']) !!}
	</div>
	<label class="col-form-label col-sm-1 text-sm-end">Peso</label>
	<div class="col-sm-2">
		{!! Form::text('peso', null, ['class' => 'form-control decimal','data-validation' => 'required']) !!}
	</div>
</div>

<div class="mb-3 row">
	<div class="col-sm-10 ms-sm-auto">
		<a href="{{ route('user.paciente.index') }}" class="btn btn-danger">
