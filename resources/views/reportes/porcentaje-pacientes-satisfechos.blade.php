...
<div class="row mb-2 mb-xl-3">
	<div class="col-auto d-none d-sm-block">
		<h3><strong>Porcentaje de pacientes satisfechos</strong></h3>
	</div>
</div>
<div class="card">
	<div class="card-body">
...
<script>
	...
	function listar(){
		...
		$('#sintomas').DataTable( {
			...
			"ajax":{
				"method":"POST",
				"url": "{{ route('porcentaje.pacientes.satisfechos.filter') }}",
			...
			{
				extend: 'excelHtml5',
				title: 'Sistema experto - Porcentaje de pacientes satisfechos',
